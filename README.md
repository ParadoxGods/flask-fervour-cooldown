...
![til](.\RuneLite_ZP2WXMg17t.gif)
Features:
- Reads the game's Flask of Fervour cooldown clock directly
- Falls back to click, chat message, and damage tracking if the cooldown clock is unavailable
